...
//            var sandwiches = new List<Sandwich>
//            {
//                new Sandwich { Id = 1, Category = "Deluxe" },
//                new Sandwich { Id = 2, Category = null },          // skal ignoreres
//                new Sandwich { Id = 3, Category = "Standard" }
//            };

//            var result = service.SortByCriteria(sandwiches, "Category");

//            Assert.AreEqual(2, result.Count); // kun 2 med ikke-null Category
